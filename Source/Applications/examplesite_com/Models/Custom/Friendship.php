...
class Friendship extends DataObject{
	...
	public static function cast(DataObject $DataObject){
		return ($DataObject instanceof Friendship)?$DataObject:new Friendship($DataObject->toArray());
	}
...
class FriendshipCollection extends DataCollection{
	public function __construct(Array $array_of_objects=null){
		$this->setCollectionType('Friendship');
	...
	public function getFriendshipByFieldValue($column_name, $data_value, $return_blank_object_if_null=true){
		$return = parent::getObjectByFieldValue($column_name, $data_value, $return_blank_object_if_null);
		return ($return instanceof Friendship)?$return:new Friendship($return->toArray());
	}
	
	public function getFriendshipByIndex($index, $return_blank_object_if_null=true){
