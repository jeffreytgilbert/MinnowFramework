...
class SettingGroup extends DataObject{
	...
	public static function cast(DataObject $DataObject){
		return ($DataObject instanceof SettingGroup)?$DataObject:new SettingGroup($DataObject->toArray());
	}
...
class SettingGroupCollection extends DataCollection{
	public function __construct(Array $array_of_objects=null){
		$this->setCollectionType('SettingGroup');
	...
	public function getSettingGroupByFieldValue($column_name, $data_value, $return_blank_object_if_null=true){
		$return = parent::getObjectByFieldValue($column_name, $data_value, $return_blank_object_if_null);
		return ($return instanceof SettingGroup)?$return:new SettingGroup($return->toArray());
	}
	
	public function getSettingGroupByIndex($index, $return_blank_object_if_null=true){
