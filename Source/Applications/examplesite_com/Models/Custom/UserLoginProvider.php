...
class UserLoginProvider extends DataObject{
	...
	public static function cast(DataObject $DataObject){
		return ($DataObject instanceof UserLoginProvider)?$DataObject:new UserLoginProvider($DataObject->toArray());
	}
...
class UserLoginProviderCollection extends DataCollection{
	public function __construct(Array $array_of_objects=null){
		$this->setCollectionType('UserLoginProvider');
	...
	public function getUserLoginProviderByFieldValue($column_name, $data_value, $return_blank_object_if_null=true){
		$return = parent::getObjectByFieldValue($column_name, $data_value, $return_blank_object_if_null);
		return ($return instanceof UserLoginProvider)?$return:new UserLoginProvider($return->toArray());
	}
	
	public function getUserLoginProviderByIndex($index, $return_blank_object_if_null=true){
