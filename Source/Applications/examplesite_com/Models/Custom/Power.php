...
class Power extends DataObject{
	...
	public static function cast(DataObject $DataObject){
		return ($DataObject instanceof Power)?$DataObject:new Power($DataObject->toArray());
	}
...
class PowerCollection extends DataCollection{
	public function __construct(Array $array_of_objects=null){
		$this->setCollectionType('Power');
	...
	public function getPowerByFieldValue($column_name, $data_value, $return_blank_object_if_null=true){
		$return = parent::getObjectByFieldValue($column_name, $data_value, $return_blank_object_if_null);
		return ($return instanceof Power)?$return:new Power($return->toArray());
	}
	
	public function getPowerByIndex($index, $return_blank_object_if_null=true){
