...
class UserInvite extends DataObject{
	public function __construct(Array $data=array()){
		$this->addAllowedData(array(
			'user_invite_id'=>DataType::NUMBER,
			'user_id'=>DataType::NUMBER,
			'UserAccount'=>DataType::OBJECT,
			'code'=>DataType::TEXT,
			'code_used_by'=>DataType::NUMBER,
	...
	public static function cast(DataObject $DataObject){
		return ($DataObject instanceof UserInvite)?$DataObject:new UserInvite($DataObject->toArray());
	}
...
class UserInviteCollection extends DataCollection{
	public function __construct(Array $array_of_objects=null){
		$this->setCollectionType('UserInvite');
	...
	public function getUserInviteByFieldValue($column_name, $data_value, $return_blank_object_if_null=true){
		$return = parent::getObjectByFieldValue($column_name, $data_value, $return_blank_object_if_null);
		return ($return instanceof UserInvite)?$return:new UserInvite($return->toArray());
	}
	
	public function getUserInviteByIndex($index, $return_blank_object_if_null=true){
