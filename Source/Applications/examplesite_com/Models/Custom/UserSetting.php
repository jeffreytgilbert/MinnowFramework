...
class UserSetting extends DataObject{
	...
	public static function cast(DataObject $DataObject){
		return ($DataObject instanceof UserSetting)?$DataObject:new UserSetting($DataObject->toArray());
	}
...
class UserSettingCollection extends DataCollection{
	public function __construct(Array $array_of_objects=null){
		$this->setCollectionType('UserSetting');
	...
	public function getUserSettingByFieldValue($column_name, $data_value, $return_blank_object_if_null=true){
		$return = parent::getObjectByFieldValue($column_name, $data_value, $return_blank_object_if_null);
		return ($return instanceof UserSetting)?$return:new UserSetting($return->toArray());
	}
	
	public function getUserSettingByIndex($index, $return_blank_object_if_null=true){
