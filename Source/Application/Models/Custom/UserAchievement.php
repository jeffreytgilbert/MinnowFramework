...
class UserAchievement extends DataObject{
	...
	public static function cast(DataObject $DataObject){
		return ($DataObject instanceof UserAchievement)?$DataObject:new UserAchievement($DataObject->toArray());
	}
	...
	public function getAchievement(){
		return ($this->getObject('Achievement') instanceof Achievement)
...
class UserAchievementCollection extends DataCollection{
	public function __construct(Array $array_of_objects=null){
		$this->setCollectionType('UserAchievement');
	...
	public function getUserAchievementByFieldValue($column_name, $data_value, $return_blank_object_if_null=true){
		$return = parent::getObjectByFieldValue($column_name, $data_value, $return_blank_object_if_null);
		return ($return instanceof UserAchievement)?$return:new UserAchievement($return->toArray());
	}
	
	public function getUserAchievementByIndex($index, $return_blank_object_if_null=true){
